...
public class QRCodeUtil {
    ...
    //传入参数并且以BASE64Encoder的字符串返回
    public static String QRCode(Map<String,Object> param) throws IOException {
        ...
        try {
            ...
            //查询设备信息放在这里面
            BufferedImage bufferedImage= QRCodeUtil.getBufferedImage(content, 200,null);
        ...
        return encoder.encode(imageContent);
    }
